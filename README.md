...
curl --proto '=https' \
  ...
  https://raw.githubusercontent.com/appsec-foundry/aiscb/782d59355fe88e96f67ac79f34d8d3899fd419c0/setup.sh &&
echo 'cef465e7e47ea2fced412c19f68adf0c303bc33fe3bab6218acd460982e42972  aiscb-setup.sh' |
  sha256sum --check &&
bash aiscb-setup.sh
```
