...
curl --proto '=https' \
  ...
  https://raw.githubusercontent.com/appsec-foundry/aiscb/410de6a57a5956266132d9dd066c740ac63e56f7/setup.sh &&
echo '2f1182844a8e96be62c4bd7866cf5f22db5e2a8cbab591d65ea4fcab43db54ae  aiscb-setup.sh' |
  sha256sum --check &&
bash aiscb-setup.sh
```
