...
curl --proto '=https' \
  ...
  https://raw.githubusercontent.com/appsec-foundry/aiscb/b0b0a31b960fc5525a47c58e900564a81016d985/setup.sh &&
echo 'f8eec751646d0e3d0254a7c1d3a327af5a0c631600cc1e68801570ed0a32f1ac  aiscb-setup.sh' |
  sha256sum --check &&
bash aiscb-setup.sh
```
...
`install-codex` and `install-copilot` work like `install-claude`. Project installations support Claude Code, Codex, and GitHub Copilot; user installations support Claude Code, Codex, and Copilot CLI.
