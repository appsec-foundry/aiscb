...
4.0). Modules complete this always-on core. On `baseline?`, answer without
reading files: baseline, source, modules, and overlays.
...
# Secrets and Bootstrap Module

`module-id: aiscb:secrets-bootstrap`. Load for credentials, passwords, tokens,
